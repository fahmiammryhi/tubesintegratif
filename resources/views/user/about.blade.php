    ...
    <main>
        <div class=" dark:bg-gray-900">
                ...
                <div class="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
                    <div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        ...
                        <div class="flex flex-col">
                            <h4 class="text-lg font-semibold text-center md:text-left">Nathanael Cruel Angel Bin Pragos</h4>
                            <p class="dark:text-gray-400">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Optio, excepturi! Ea, placeat nesciunt repudiandae facere quam corrupti voluptate molestias esse impedit labore delectus beatae praesentium! Commodi saepe ea est laborum.</p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
                    <div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        <img src="/img/admin.jpeg" alt="" class="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-700">
                        <div class="flex flex-col">
                            <h4 class="text-lg font-semibold text-center md:text-left">Mahendra Ganteng dari jauh</h4>
                            <p class="dark:text-gray-400">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Optio, excepturi! Ea, placeat nesciunt repudiandae facere quam corrupti voluptate molestias esse impedit labore delectus beatae praesentium! Commodi saepe ea est laborum.</p>
                        </div>
                    </div>
                    <div class="flex justify-center pt-4 space-x-4 align-center">
            ...
            <div class="container">
                <div class="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
                    <div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        <img src="/img/arkan.png" alt="" class="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-700">
                        <div class="flex flex-col">
                            <h4 class="text-lg font-semibold text-center md:text-left">Arkan Manekan Pak Arkan</h4>
            ...
            <div class="container">
                <div class="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
                    <div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        ...
                        <div class="flex flex-col">
                            <h4 class="text-lg font-semibold text-center md:text-left">Ilyas Kurniawan Wingchun</h4>
                            <p class="dark:text-gray-400">Sed non nibh iaculis, posuere diam vitae, consectetur neque. Integer velit ligula, semper sed nisl in, cursus commodo elit. Pellentesque sit amet mi luctus ligula euismod lobortis ultricies et nibh.</p>
                        </div>
                    </div>
                    <div class="flex justify-center pt-4 space-x-4 align-center">
            ...
            <div class="container">
                <div class="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
                    <div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        ...
                        <div class="flex flex-col">
                            <h4 class="text-lg font-semibold text-center md:text-left">Edwin Wahyu Prahgos</h4>
                            <p class="dark:text-gray-400">Sed non nibh iaculis, posuere diam vitae, consectetur neque. Integer velit ligula, semper sed nisl in, cursus commodo elit. Pellentesque sit amet mi luctus ligula euismod lobortis ultricies et nibh.</p>
                        </div>
                    </div>
                    <div class="flex justify-center pt-4 space-x-4 align-center">
            ...
            <div class="container">
                <div class="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
                    <div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        ...
                        <div class="flex flex-col">
                            <h4 class="text-lg font-semibold text-center md:text-left">Pahmi Manemi</h4>
                            <p class="dark:text-gray-400">Sed non nibh iaculis, posuere diam vitae, consectetur neque. Integer velit ligula, semper sed nisl in, cursus commodo elit. Pellentesque sit amet mi luctus ligula euismod lobortis ultricies et nibh.</p>
                        </div>
                    </div>
                    <div class="flex justify-center pt-4 space-x-4 align-center">
