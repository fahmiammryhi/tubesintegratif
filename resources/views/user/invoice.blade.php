...
<body>
    ...
    <main class="mt-10 mb-5 flex justify-center items-center">
        @if ($transaksi)
            <div
                class="flex flex-col p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-gray-50 text-gray-800" >
                <div class="card-title flex justify-center items-center">
                    <img src="/img/Jastopup.png" alt="" width="100">
                </div>
                <div class="flex space-x-4">
                    <div class="flex flex-col space-y-1">
                        <a rel="noopener noreferrer" href="#" class="text-sm font-semibold">Invoice Pesanan</a>
                        <span class="text-xs text-gray-600">{{ $transaksi->email }}</span>
                    </div>
                </div>
                <div>
                    <h2 class="mb-1 text-xl font-semibold">{{ $transaksi->game }}</h2>
                    <p class="text-sm text-gray-600">Total - {{ $transaksi->qty }}</p>
                </div>
                ...
                <div>
                    ...
                    <p class=" h-4 fill-current text-orange-600">{{ $transaksi->status }}</p>
                </div>
